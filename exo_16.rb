...
if user_number_choice < 1 || user_number_choice > 25
    ...
    (1..user_number_choice).each do |i|
        #ici entre ' ' c'est des espaces vu que la pyramide part de la gauche, pour bien centrer les # il faut mettre des espaces, du coup on précide bien que pour le nombre d'espace c'est ' ' * le nombre qu'a choisi l'utilisateur - le nombre du comptage
